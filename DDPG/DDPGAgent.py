...
class Actor(nn.Module):
    ...
    def forward(self, state):
        ...
        return self.tanh(self.l2(z)) # tanh activation for continuous action states
...
class DDPGAgent:
    def __init__(self, state_dim, action_dim, replay_buffer_size=1e6, gamma=0.99, tau=0.001, batch_size=8):
    ...
    def train(self):
        ...
        y_Q = torch.add(rewards, self.gamma * self.target_critic(next_states, self.target_actor(next_states)))
